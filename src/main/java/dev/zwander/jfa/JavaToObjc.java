...
import dev.zwander.jfa.annotation.ConformsToProtocols;
import dev.zwander.jfa.annotation.InheritMethodsUpTo;
import dev.zwander.jfa.annotation.Superclass;
import dev.zwander.jfa.annotation.Unmapped;
import dev.zwander.jfa.cleanup.NSCleaner;
import dev.zwander.jfa.foundation.Foundation;
import dev.zwander.jfa.foundation.ID;
import dev.zwander.jfa.util.StreamUtils;
